...
from Query_Decomposition_RAG import load_vectorstore, setup_language_model_chain
        ...
        with st.chat_message("assistant"):
            with st.spinner("Thinking..."):
                ...
                for sub_question in questions:
                    ...
                    answer = (prompt1 | model | StrOutputParser()).invoke({"context": retrieved_docs,"question": sub_question})
                ...
                response = invoke_chain(st.session_state.rag_chain, prompt, context)
